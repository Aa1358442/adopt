<template>
    <div>
      <el-row>
        <el-col :span="14">
          <div>
            <el-table
              ...
              <el-table-column prop="name" label="发布用户名" width="100"></el-table-column>
        ...
        <el-col :span="10">
          <div style="background-color: #C3ECFF;padding-right: 50px;margin-left: 20px;">
    ...
    export default {
      ...
      methods:{
        ...
        findAdoptList(page,size) {
          ...
          let _this = this;
          this.$http.get("http://localhost:9150/adopt/findAdoptListByPhone?pageNow=" + page + "&pageSize=" + size+"&phone="+phone).then(function (result) {
